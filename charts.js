function init() {
  ...
  function buildCharts(sample) {
    ...
    d3.json("samples.json").then((data) => {
      ...
      var barLayout = {
        title: "<b>The Top 10 Bacteria Cultures",
        yaxis: {
          tickmode: "array",
        ...
        annotations: [{
          ...
          y: -0.25,
          yanchor: 'center',
          text: '<b>The bar chart displays the top 10 bacterial species (OTUs)<br>with the number of samples found in the selected belly button</b>',
          showarrow: false
        }]
      };
      ...
      var gaugeLayout = { 
        ...
        annotations: [{
          ...
          y: 0,
          yanchor: 'center',
          text: "The gauge displays your belly button wash frequency per week.",
          showarrow: false
        }]
      };
